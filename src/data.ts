...
export const SECTIONS: SectionData[] = [
  ...
  steps: [
    ...
    { 
      ...
      icon: Zap },
    { text: 'Duchowy reboot Europy. Mówili, że to duchowe cmentarzysko, tymczasem we Francji i Belgii mamy rekordowe skoki chrztów dorosłych. „Przyszedłem ogień rzucić na ziemię” (Łk 12, 49) – ten ogień właśnie przeskakuje na nowe pokolenie, którego nie zadowala już pusty konsumpcjonizm.', icon: Flame }
  ],
  icon: Zap,
  theme: {
